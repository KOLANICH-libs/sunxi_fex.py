sunxi_fex.py
============
[wheel (GitLab)](https://gitlab.com/KOLANICH-libs/sunxi_fex.py/-/jobs/artifacts/master/raw/dist/sunxi_fex-0.CI-py3-none-any.whl?job=build)
...
![GitLab Build Status](https://gitlab.com/KOLANICH-libs/sunxi_fex.py/badges/master/pipeline.svg)
![GitLab Coverage](https://gitlab.com/KOLANICH-libs/sunxi_fex.py/badges/master/coverage.svg)
[![Coveralls Coverage](https://img.shields.io/coveralls/KOLANICH-libs/sunxi_fex.py.svg)](https://coveralls.io/r/KOLANICH-libs/sunxi_fex.py)
